...
const Features1 = () => {
  return (
    <section
      className="w-full h-screen px-6 md:px-20 py-16 bg-gradient-to-br from-purple-800 via-purple-600 to-pink-500 text-white flex items-center"
    >
      <div className="flex flex-col md:flex-row items-center justify-between gap-12 w-full max-w-[1440px] mx-auto">

        {/* Text Content */}
        <div className="w-full md:w-1/2 flex flex-col gap-6">
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight font-[Poppins]">
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <img
            ...
            className="w-full max-w-[700px] h-auto rounded-xl border-4 border-white shadow-lg transition-transform duration-500 hover:scale-105"
          />
        </div>
