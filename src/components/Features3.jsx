...
const Features3 = () => {
  return (
    <section className="w-full min-h-screen px-4 sm:px-6 md:px-20 py-12 md:py-16 bg-gradient-to-br from-pink-600 via-purple-500 to-purple-700 flex items-center">
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-12 w-full max-w-[1440px] mx-auto text-white">

        {/* Text Content */}
        <div className="w-full md:w-1/2 flex flex-col gap-6 md:gap-8">
          <h1 className="font-bold text-3xl sm:text-4xl md:text-5xl leading-tight font-[Poppins]">
          ...
          <div className="space-y-4 mt-2">
            {[
              ...
              <div key={index} className="flex items-start gap-3 text-base sm:text-lg text-purple-200">
                <FontAwesomeIcon icon={faCube} className="text-pink-200 text-xl sm:text-2xl mt-1" />
                <span>{item}</span>
              </div>
            ))}
          </div>
        ...
        <div className="w-full md:w-1/2 flex justify-center mt-8 md:mt-0">
          <img
            ...
            className="w-full max-w-md sm:max-w-lg md:max-w-xl h-auto rounded-xl object-cover border-4 border-white shadow-lg transition-transform duration-500 hover:scale-105"
          />
        </div>
